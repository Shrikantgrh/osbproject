  ...
  <xsl:template match="/">
    <tns:ODM FileType="Transactional" FileOID="{/ns0:Subject/tns:ODM/@FileOID}"
      ...
      <xsl:for-each select="/ns0:Subject/tns:ODM/tns:ClinicalData">
        <xsl:if test='tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="VS" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W52" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="HT" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "SUBJECT" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="EN" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="PE" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="HEM" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="CHEM" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="URIN" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="UPREG" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="PK" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "W16" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="ADA" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "SCRN" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="DM" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "AE" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="AE" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "CNMEDM" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="PCM" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "ADT" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="ADT" or tns:SubjectData/tns:StudyEventData/@StudyEventOID = "SCRN" and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID ="MH"'>
          ...
          <tns:ClinicalData MetaDataVersionOID="{@MetaDataVersionOID}"
            ...
            <tns:SubjectData TransactionType="Update">
              ...
              <!-- SUBJECT CONFIG-->
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'SUBJECT')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='EN'))">
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="( @ItemOID='EN.SUBNUM1')">
                            ...
                            <tns:ItemData ItemOID="EN.PTRIAL" Value="3" TransactionType="Update" mdsol:Lock="AsFound"></tns:ItemData>
                          </xsl:when>
                        </xsl:choose>
                      </xsl:for-each>
                    </tns:ItemGroupData>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='VS'))">
            ...
            <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W52')and 
            (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='HT'))">
              <tns:StudyEventData StudyEventOID="BASE">
                <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                  <xsl:attribute name="StudyEventRepeatKey">
                    <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
                ...
                <tns:FormData>
                  ...
                  <tns:ItemGroupData>
                    ...
                    <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                      <xsl:choose>
                        <xsl:when test="( @ItemOID='HT.HTYN') or ( @ItemOID='HT.HTDAT') or ( @ItemOID='HT.HTRAN')">
                          <tns:ItemData mdsol:Lock="AsFound">
                            <xsl:if test="@ItemOID">
                              <xsl:attribute name="ItemOID">
                                <xsl:value-of select="concat('VS.',substring-after(@ItemOID,'.'))"/>
              ...
              <!--end-->
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='PE'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
                        ...
                        <xsl:choose>
                          <xsl:when test="( @ItemOID='PE.PEYN') or (@ItemOID='PE.RECGUID') or  (@ItemOID='PE.PEDAT') or  (@ItemOID='PE.PEBSYS') or  (@ItemOID='PE.PEND') or  (@ItemOID='PE.PEXAM') or  (@ItemOID='PE.PECLINSG') or  (@ItemOID='PE.OTHSP')">
                            <tns:ItemData mdsol:Lock="AsFound">
                              ...
                              <xsl:choose>
                                <xsl:when test="(@ItemOID='PE.RECGUID')">
                                  <xsl:attribute name="TransactionType">Context</xsl:attribute>
                                </xsl:when>
                                <xsl:otherwise>
                                  <xsl:attribute name="TransactionType">Update</xsl:attribute>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='HEM'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='CHEM'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='URIN'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='UPREG'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='PK'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'W16')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='ADA'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
                  ...
                  <tns:FormData>
                    <xsl:if test="tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID">
                      <xsl:attribute name="FormOID">ADA</xsl:attribute>
                    </xsl:if>
                    <xsl:if test="tns:SubjectData/tns:StudyEventData/tns:FormData/@FormRepeatKey">
                      <xsl:attribute name="FormRepeatKey">
                        <xsl:value-of select="tns:SubjectData/tns:StudyEventData/tns:FormData/@FormRepeatKey"/>
                    ...
                    <tns:ItemGroupData>
                      <xsl:if test="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupOID">
                        <xsl:attribute name="ItemGroupOID">
                          <xsl:value-of select="java:replaceAll(tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupOID,'ADA','ADA')"/>
                        </xsl:attribute>
                      </xsl:if>
                      <xsl:if test="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupRepeatKey">
                        <xsl:attribute name="ItemGroupRepeatKey">
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="( @ItemOID='ADA.ADADAT') or (@ItemOID='ADA.RECGUID') or  (@ItemOID='ADA.ADATM') or  (@ItemOID='ADA.ADAND')">
                            <tns:ItemData mdsol:Lock="AsFound">
                              <xsl:if test="@ItemOID">
                                <xsl:attribute name="ItemOID">
                                  <xsl:value-of select="concat('ADA.',substring-after(@ItemOID,'.'))"/>
                                </xsl:attribute>
                              </xsl:if>
                              <xsl:if test="@Value">
                                <xsl:attribute name="Value">
                              ...
                              <xsl:choose>
                                <xsl:when test="(@ItemOID='ADA.RECGUID')">
                                  <xsl:attribute name="TransactionType">Context</xsl:attribute>
                                </xsl:when>
                                <xsl:otherwise>
                                  <xsl:attribute name="TransactionType">Update</xsl:attribute>
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'SCRN')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='DM'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
                  ...
                  <tns:FormData>
                    ...
                    <tns:ItemGroupData>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="( @ItemOID='DM.BRTHDAT') or (@ItemOID='DM.BIRTHY')or (@ItemOID='DM.RECGUID') or  (@ItemOID='DM.AGEDEU') or(@ItemOID='DM.AGEY') or  (@ItemOID='DM.AGEG') or  (@ItemOID='DM.SEX')">
                            <tns:ItemData mdsol:Lock="AsFound">
                              <xsl:if test="@ItemOID">
                                <xsl:attribute name="ItemOID">
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'AE')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='AE'))">
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'CNMEDM')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='PCM'))">
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="( @ItemOID='PCM.PCMYN') or (@ItemOID='PCM.RECGUID') or  (@ItemOID='PCM.PCMTERM') or  (@ItemOID='PCM.PCMINDC')  or  (@ItemOID='PCM.PCMPTHSP') or  (@ItemOID='PCM.PCMDOS') or  (@ItemOID='PCM.PCMDOSU') or  (@ItemOID='PCM.DOSUSP') or  (@ItemOID='PCM.PCMFREQ') or  (@ItemOID='PCM.FREQSP') or  (@ItemOID='PCM.PCMROUTE') or  (@ItemOID='PCM.ROUTESP') or  (@ItemOID='PCM.PCMSTDAT') or  (@ItemOID='PCM.PCMSTUNK') or  (@ItemOID='PCM.PCMENDAT') or  (@ItemOID='PCM.PCMONGO')">
                            <tns:ItemData mdsol:Lock="AsFound">
                              <xsl:choose>
                                <xsl:when test="(@ItemOID='PCM.PCMHDSL')">
                                  <xsl:attribute name="ItemOID">
                                    <xsl:value-of select="concat('PCM.','PCMHDSL')"/>
                                  </xsl:attribute>
                                </xsl:when>
                                <xsl:otherwise>
                                  <xsl:attribute name="ItemOID">
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'ADT')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='ADT'))">
                <tns:StudyEventData StudyEventOID="ADT">
                  ...
                  <tns:FormData>
                    ...
                    <tns:ItemGroupData>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="( @ItemOID='ADT.ADTYN') or (@ItemOID='ADT.RECGUID') or  (@ItemOID='ADT.ADTERM') or  (@ItemOID='ADT.ADTIND') or  (@ItemOID='ADT.ADTDOSE') or  (@ItemOID='ADT.ADTDOSU') or  (@ItemOID='ADT.OTHSP') or  (@ItemOID='ADT.ADTFRQ') or  (@ItemOID='ADT.OTHSP1') or  (@ItemOID='ADT.ADTROUTE') or  (@ItemOID='ADT.OTHSP2') or  (@ItemOID='ADT.ADTHEAD') or  (@ItemOID='ADT.ADTRUNK') or  (@ItemOID='ADT.ADTUE') or  (@ItemOID='ADT.ADTLE') or  (@ItemOID='ADT.ADTSTDAT') or  (@ItemOID='ADT.ADTENDAT') or  (@ItemOID='ADT.ADTONG')">
                            <tns:ItemData mdsol:Lock="AsFound">
                              <xsl:if test="@ItemOID">
                                <xsl:attribute name="ItemOID">
              ...
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'SCRN')and 
              (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='MH'))">
                <tns:StudyEventData StudyEventOID="BASE">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
