  ...
  <xsl:template match="/">
    <tns:ODM FileType="Transactional" FileOID="{/ns0:Subject/tns:ODM/@FileOID}" CreationDateTime="{/ns0:Subject/tns:ODM/@CreationDateTime}" ODMVersion="{/ns0:Subject/tns:ODM/@ODMVersion}">
      <xsl:for-each select="/ns0:Subject/tns:ODM/tns:ClinicalData">
        <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;ASCREEN&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;DM&quot; or tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;EOS&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;EXIT&quot; or tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;LTEDOSE1&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;EX_DIS&quot; or tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;LTEDOSE2&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;EX_DIS&quot; or tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;LTEDOSE3&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;EX_DIS&quot; or tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;LTEDOSE4&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;EX_DIS&quot; or tns:SubjectData/tns:StudyEventData/@StudyEventOID = &quot;SUBJECT&quot; and tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID = &quot;SUBJINFO&quot;">
          ...
          <tns:ClinicalData MetaDataVersionOID="{@MetaDataVersionOID}" StudyOID="{/ns0:Subject/ns1:RaveUrls/ns1:RaveUrl[@utype='TARGET']/ns1:studyName}">
            <tns:SubjectData TransactionType="Update">
              <xsl:attribute name="SubjectKey">
                <xsl:value-of select="concat (&quot;161-&quot;, tns:SubjectData/@SubjectKey )"/>
              </xsl:attribute>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:if test="@ItemOID = &quot;SUBJINFO.SUBJID&quot;">
                          ...
                          <tns:ItemData mdsol:Lock="AsFound" ItemOID="SUBJINFO.SUBJID1">
                            <xsl:if test="@Value">
                              <xsl:attribute name="Value">
                                <xsl:value-of select="concat (&quot;161-&quot;, @Value )"/>
                              </xsl:attribute>
                            </xsl:if>
                            <xsl:if test="@IsNull">
                              <xsl:attribute name="IsNull">
                          ...
                          <tns:ItemData mdsol:Lock="AsFound" ItemOID="SUBJINFO.PSPNUM" Value="118161"/>
                          <tns:ItemData mdsol:Lock="AsFound" ItemOID="SUBJINFO.PSPNUMOT" Value=""/>
                ...
                <tns:StudyEventData StudyEventOID="ASCREEN">
                  ...
                  <tns:FormData>
                    ...
                    <tns:ItemGroupData>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="(@ItemOID = 'DM.BRTHDAT') or (@ItemOID = 'DM.SEX') or (@ItemOID = 'DM.ETHNIC') or (@ItemOID = 'DM.WHT') or (@ItemOID = 'DM.BORAA') or (@ItemOID = 'DM.ASIAN') or (@ItemOID = 'DM.NHOPI')or (@ItemOID = 'DM.AIAN')or (@ItemOID = 'DM.OTHER')or (@ItemOID = 'DM.RACEOTH')">
              ...
              <xsl:if test="(tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'EOS')and (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='EXIT')">
                <!-- <tns:StudyEventData StudyEventOID="SUBJECT">
                  ...
                  <tns:FormData>
                    ...
                    <tns:ItemGroupData>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="(@ItemOID = 'EXIT.LSDOSDAT2') and @Value and @Value!=''">
                            <tns:ItemData mdsol:Lock="AsFound" mdsol:Lock="AsFound">
                              <xsl:attribute name="ItemOID">SDTSINTG.PLDOSDAT1</xsl:attribute>
                              <xsl:if test="@Value">
                                <xsl:attribute name="Value">
                                  <xsl:value-of select="@Value"/>
                                </xsl:attribute>
                ...
                <tns:StudyEventData StudyEventOID="SUBJECT">
                  ...
                  <tns:FormData FormOID="SDTSINTG" TransactionType="Update">
                    ...
                    <tns:ItemGroupData ItemGroupOID="SDTSINTG" TransactionType="Update">
                      <xsl:if test="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupRepeatKey">
                        <xsl:attribute name="ItemGroupRepeatKey">
                          <xsl:value-of select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupRepeatKey"/>
                        </xsl:attribute>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="(@ItemOID = 'EXIT.LSDOSDAT2') and @Value">
                          ...
                          <xsl:when test="(@ItemOID = 'EXIT.LSDOSDAT2')and (@Value='' or @IsNull='Yes')">
                            <tns:ItemData mdsol:Lock="AsFound" ItemOID="SDTSINTG.PLDOSDAT1" Value=""/>
                          </xsl:when>
                        </xsl:choose>
                      </xsl:for-each>
                    </tns:ItemGroupData>
              ...
              <!--LTEDOSE1 and EX_DIS-->
              <xsl:if test="((tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'LTEDOSE1')and (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='EX_DIS')or (tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'LTEDOSE2')and (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='EX_DIS') or (tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'LTEDOSE3')and (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='EX_DIS') or (tns:SubjectData/tns:StudyEventData/@StudyEventOID = 'LTEDOSE4')and (tns:SubjectData/tns:StudyEventData/tns:FormData/@FormOID='EX_DIS') )">
                <tns:StudyEventData StudyEventOID="SUBJECT">
                  <xsl:if test="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey">
                    <xsl:attribute name="StudyEventRepeatKey">
                      <xsl:value-of select="tns:SubjectData/tns:StudyEventData/@StudyEventRepeatKey"/>
                  ...
                  <tns:FormData>
                    ...
                    <tns:ItemGroupData ItemGroupOID="{java:replaceAll(tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupOID,'EX_DIS','SDTSINTG')}">
                      <xsl:if test="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupRepeatKey">
                        <xsl:attribute name="ItemGroupRepeatKey">
                          <xsl:value-of select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/@ItemGroupRepeatKey"/>
                        </xsl:attribute>
                      ...
                      <xsl:for-each select="tns:SubjectData/tns:StudyEventData/tns:FormData/tns:ItemGroupData/tns:ItemData">
                        <xsl:choose>
                          <xsl:when test="(@ItemOID = 'EX_DIS.KITPLAC')">
                            <tns:ItemData mdsol:Lock="AsFound" ItemOID="{concat (&quot;SDTSINTG.&quot;, substring-after (@ItemOID, &quot;.&quot; ),&quot;1&quot; )}">
                              <xsl:if test="@Value">
                                <xsl:attribute name="Value">
                                  <xsl:value-of select="@Value"/>
                                </xsl:attribute>
